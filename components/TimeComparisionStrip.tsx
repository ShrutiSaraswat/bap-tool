    ...
    <section className="relative bg-gradient-to-r from-[#fef2f2] via-[#f9fafb] to-[#eff6ff] border-b border-slate-200 overflow-hidden">
      ...
      >
        ...
        <motion.div className="flex flex-col gap-2" variants={fadeUp}>
          ...
          <p className="text-base text-slate-800 max-w-3xl mb-2">
        ...
        <motion.div className="space-y-4" variants={fadeUp}>
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-3 text-base text-slate-800">
            <div className="flex items-center gap-2 rounded-full bg-white/80 px-3 py-1.5 shadow-sm border border-slate-200">
              <span className="h-2.5 w-2.5 rounded-full bg-[#005f63]" />
          ...
          >
            ...
            <div className="mt-1 space-y-2">
              <div className="flex items-center justify-between gap-3">
                ...
                <p className="text-base text-slate-600">Less than 1 year</p>
              </div>
              <div className="h-2.5 rounded-full bg-slate-100 overflow-hidden">
                <div className="h-2.5 w-[28%] rounded-full bg-gradient-to-r from-[#005f63] to-[#0f766e]" />
              </div>
              <div className="flex justify-between text-[0.78rem] text-slate-500">
                <span>Start</span>
                <span>1 year</span>
                <span>4 years</span>
              </div>
          ...
          >
            ...
            <div className="mt-1 space-y-2">
              <div className="flex items-center justify-between gap-3">
                ...
                <p className="text-base text-slate-600">About 1 year</p>
              </div>
              <div className="h-2.5 rounded-full bg-slate-100 overflow-hidden">
                <div className="h-2.5 w-[40%] rounded-full bg-gradient-to-r from-[#f59e0b] via-[#f4b41a] to-[#d71920]" />
              </div>
              <div className="flex justify-between text-[0.78rem] text-slate-500">
                <span>Start</span>
                <span>1 year</span>
          ...
          >
            ...
            <div className="mt-1 space-y-2">
              <div className="flex items-center justify-between gap-3">
                ...
                <p className="text-base text-slate-600">2 - 4+ years</p>
              </div>
              <div className="h-2.5 rounded-full bg-slate-100 overflow-hidden">
                <div className="h-2.5 w-[82%] rounded-full bg-gradient-to-r from-[#b91c1c] via-[#7f1d1d] to-[#020617]" />
              </div>
              <div className="flex justify-between text-[0.78rem] text-slate-500">
                <span>Start</span>
                <span>1 year</span>
